...
HD_PWD='d:/zynq_mizar/sdk_demo/7_custom_ip/managed_ip_project/managed_ip_project.tmp/pwm_ip_v1_0_project/pwm_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_ip_v1_0.tcl
