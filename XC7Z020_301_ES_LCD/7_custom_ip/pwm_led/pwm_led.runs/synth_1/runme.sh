...
HD_PWD='D:/ZYNQ_Mizar/SDK_Demo/7_custom_ip/pwm_led/pwm_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_led_wrapper.tcl
