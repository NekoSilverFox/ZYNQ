...
################################################################
# This is a generated script based on design: PS_design
#
...
proc create_root_design { parentCell } {
  ...
  set aix_gpio_key [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 aix_gpio_key ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports aix_gpio_key] [get_bd_intf_pins axi_gpio_0/GPIO]
...
preplace port aix_gpio_key -pg 1 -y 310 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 250 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 110 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 320 -defaultsOSRD
...
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 10 20 370
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 1 390
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 250 NJ 250 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 400 340 NJ
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ
preplace netloc axi_gpio_0_ip2intc_irpt 1 0 4 30 390 NJ 390 NJ 390 880
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 360 410 360 650
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 650
levelinfo -pg 1 -10 200 530 770 900 -top 0 -bot 400
",
}
