...
################################################################
# This is a generated script based on design: ov5640_hdmi_design
#
...
# source ov5640_hdmi_design_script.tcl
...
set design_name ov5640_hdmi_design
...
proc create_root_design { parentCell } {
  ...
  set hdmi_tx_chn_b_p [ create_bd_port -dir O hdmi_tx_chn_b_p ]
  set hdmi_tx_chn_g_n [ create_bd_port -dir O hdmi_tx_chn_g_n ]
  set hdmi_tx_chn_g_p [ create_bd_port -dir O hdmi_tx_chn_g_p ]
  set hdmi_tx_chn_r_n [ create_bd_port -dir O hdmi_tx_chn_r_n ]
  set hdmi_tx_chn_r_p [ create_bd_port -dir O hdmi_tx_chn_r_p ]
  ...
  # Create instance: hdmi_trans_0, and set properties
  set hdmi_trans_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:hdmi_trans:1.0 hdmi_trans_0 ]
  ...
  connect_bd_net -net hdmi_trans_0_hdmi_tx_chn_b_n [get_bd_ports hdmi_tx_chn_b_n] [get_bd_pins hdmi_trans_0/hdmi_tx_chn_b_n]
  connect_bd_net -net hdmi_trans_0_hdmi_tx_chn_b_p [get_bd_ports hdmi_tx_chn_b_p] [get_bd_pins hdmi_trans_0/hdmi_tx_chn_b_p]
  connect_bd_net -net hdmi_trans_0_hdmi_tx_chn_g_n [get_bd_ports hdmi_tx_chn_g_n] [get_bd_pins hdmi_trans_0/hdmi_tx_chn_g_n]
  connect_bd_net -net hdmi_trans_0_hdmi_tx_chn_g_p [get_bd_ports hdmi_tx_chn_g_p] [get_bd_pins hdmi_trans_0/hdmi_tx_chn_g_p]
  connect_bd_net -net hdmi_trans_0_hdmi_tx_chn_r_n [get_bd_ports hdmi_tx_chn_r_n] [get_bd_pins hdmi_trans_0/hdmi_tx_chn_r_n]
  connect_bd_net -net hdmi_trans_0_hdmi_tx_chn_r_p [get_bd_ports hdmi_tx_chn_r_p] [get_bd_pins hdmi_trans_0/hdmi_tx_chn_r_p]
  connect_bd_net -net hdmi_trans_0_hdmi_tx_clk_n [get_bd_ports hdmi_tx_clk_n] [get_bd_pins hdmi_trans_0/hdmi_tx_clk_n]
  connect_bd_net -net hdmi_trans_0_hdmi_tx_clk_p [get_bd_ports hdmi_tx_clk_p] [get_bd_pins hdmi_trans_0/hdmi_tx_clk_p]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ddr3_hdmi_ov5640_0/clk] [get_bd_pins image_filter_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins image_filter_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins ddr3_hdmi_ov5640_0/rst] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins hdmi_trans_0/rst] [get_bd_pins util_vector_logic_1/Res] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins hdmi_trans_0/de] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins hdmi_trans_0/image_rgb] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins hdmi_trans_0/hsync] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins hdmi_trans_0/vsync] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
