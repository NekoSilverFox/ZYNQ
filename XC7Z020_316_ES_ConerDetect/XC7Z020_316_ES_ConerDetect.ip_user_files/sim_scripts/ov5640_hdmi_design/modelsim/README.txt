...
#
# Generated by export_simulation on Sun Oct 24 01:11:55 +0300 2021
#
################################################################################
...
'-reset_run' switch to the './ov5640_hdmi_design.sh' script.

./ov5640_hdmi_design.sh -reset_run
...
./ov5640_hdmi_design.sh -noclean_files

For more information on the script, please type './ov5640_hdmi_design.sh -help'.
