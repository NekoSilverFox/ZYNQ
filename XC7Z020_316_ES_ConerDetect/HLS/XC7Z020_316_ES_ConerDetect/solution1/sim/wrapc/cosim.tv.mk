# ==============================================================
# File generated on Sun Oct 24 17:15:21 +0300 2021
...
$(ObjDir)/testCorner.cpp_pre.cpp.tb.o : testCorner.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling testCorner.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/CornerDetect.cpp_pre.cpp.tb.o : CornerDetect.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling CornerDetect.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
