...
// ==============================================================
#ifndef __doCorner_mac_mulabkb__HH__
#define __doCorner_mac_mulabkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doCorner_mac_mulabkb) {
    ...
    SC_CTOR(doCorner_mac_mulabkb):  simcore_mac_0_U ("simcore_mac_0_U") {
