...
architecture behav of rgb2gray is 
    ...
    signal idxRow_1_reg_321 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal idxCol_1_fu_248_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal idxCol_1_reg_329 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_state3 : BOOLEAN;
    signal tmp_10_reg_334 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_11_reg_339 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_7_reg_344 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_9_reg_350 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_shl_fu_260_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal p_shl1_fu_271_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_shl_cast_fu_267_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal p_shl1_cast_fu_278_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_6_fu_282_p2 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal grp_fu_301_p00 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((imgOut_1C_data_stream_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_2_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_1_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_0_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_0_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_2_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_1_V_empty_n = ap_const_logic_0)))) and (exitcond_fu_242_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                tmp_9_reg_350 <= grp_fu_301_p3(15 downto 8);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, imgIn_data_stream_0_V_empty_n, imgIn_data_stream_1_V_empty_n, imgIn_data_stream_2_V_empty_n, imgOut_3C_data_stream_0_V_full_n, imgOut_3C_data_stream_1_V_full_n, imgOut_3C_data_stream_2_V_full_n, imgOut_1C_data_stream_V_full_n, ap_CS_fsm_state3, exitcond_fu_242_p2, ap_CS_fsm_state5, ap_CS_fsm_state2, exitcond1_fu_230_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state5 => 
                if ((not(((imgOut_1C_data_stream_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_2_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_1_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_0_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state5;
                end if;
    ...
    ap_block_state3_assign_proc : process(imgIn_data_stream_0_V_empty_n, imgIn_data_stream_1_V_empty_n, imgIn_data_stream_2_V_empty_n, exitcond_fu_242_p2)
    begin
                ap_block_state3 <= (((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_0_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_2_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_1_V_empty_n = ap_const_logic_0)));
    end process;


    ap_block_state5_assign_proc : process(imgOut_3C_data_stream_0_V_full_n, imgOut_3C_data_stream_1_V_full_n, imgOut_3C_data_stream_2_V_full_n, imgOut_1C_data_stream_V_full_n)
    begin
                ap_block_state5 <= ((imgOut_1C_data_stream_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_2_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_1_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_0_V_full_n = ap_const_logic_0));
    end process;
    ...
    grp_fu_301_p0 <= grp_fu_301_p00(8 - 1 downto 0);
    grp_fu_301_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_10_reg_334),16));
    grp_fu_301_p1 <= ap_const_lv16_4C(8 - 1 downto 0);
    grp_fu_309_p0 <= grp_fu_309_p00(8 - 1 downto 0);
    grp_fu_309_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_11_reg_339),16));
    grp_fu_309_p1 <= ap_const_lv16_96(9 - 1 downto 0);
    ...
    imgIn_data_stream_0_V_read_assign_proc : process(imgIn_data_stream_0_V_empty_n, imgIn_data_stream_1_V_empty_n, imgIn_data_stream_2_V_empty_n, ap_CS_fsm_state3, exitcond_fu_242_p2)
    begin
        if ((not((((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_0_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_2_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_1_V_empty_n = ap_const_logic_0)))) and (exitcond_fu_242_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    imgIn_data_stream_1_V_read_assign_proc : process(imgIn_data_stream_0_V_empty_n, imgIn_data_stream_1_V_empty_n, imgIn_data_stream_2_V_empty_n, ap_CS_fsm_state3, exitcond_fu_242_p2)
    begin
        if ((not((((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_0_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_2_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_1_V_empty_n = ap_const_logic_0)))) and (exitcond_fu_242_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    imgIn_data_stream_2_V_read_assign_proc : process(imgIn_data_stream_0_V_empty_n, imgIn_data_stream_1_V_empty_n, imgIn_data_stream_2_V_empty_n, ap_CS_fsm_state3, exitcond_fu_242_p2)
    begin
        if ((not((((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_0_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_2_V_empty_n = ap_const_logic_0)) or ((exitcond_fu_242_p2 = ap_const_lv1_0) and (imgIn_data_stream_1_V_empty_n = ap_const_logic_0)))) and (exitcond_fu_242_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    imgOut_1C_data_stream_V_blk_n_assign_proc : process(imgOut_1C_data_stream_V_full_n, ap_CS_fsm_state5)
    begin
    ...
    imgOut_1C_data_stream_V_din <= tmp_9_reg_350;

    imgOut_1C_data_stream_V_write_assign_proc : process(imgOut_3C_data_stream_0_V_full_n, imgOut_3C_data_stream_1_V_full_n, imgOut_3C_data_stream_2_V_full_n, imgOut_1C_data_stream_V_full_n, ap_CS_fsm_state5)
    begin
        if ((not(((imgOut_1C_data_stream_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_2_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_1_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_0_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    imgOut_3C_data_stream_0_V_blk_n_assign_proc : process(imgOut_3C_data_stream_0_V_full_n, ap_CS_fsm_state5)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    imgOut_3C_data_stream_0_V_din <= tmp_9_reg_350;

    imgOut_3C_data_stream_0_V_write_assign_proc : process(imgOut_3C_data_stream_0_V_full_n, imgOut_3C_data_stream_1_V_full_n, imgOut_3C_data_stream_2_V_full_n, imgOut_1C_data_stream_V_full_n, ap_CS_fsm_state5)
    begin
        if ((not(((imgOut_1C_data_stream_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_2_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_1_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_0_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    imgOut_3C_data_stream_1_V_blk_n_assign_proc : process(imgOut_3C_data_stream_1_V_full_n, ap_CS_fsm_state5)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    imgOut_3C_data_stream_1_V_din <= tmp_9_reg_350;

    imgOut_3C_data_stream_1_V_write_assign_proc : process(imgOut_3C_data_stream_0_V_full_n, imgOut_3C_data_stream_1_V_full_n, imgOut_3C_data_stream_2_V_full_n, imgOut_1C_data_stream_V_full_n, ap_CS_fsm_state5)
    begin
        if ((not(((imgOut_1C_data_stream_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_2_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_1_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_0_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    imgOut_3C_data_stream_2_V_blk_n_assign_proc : process(imgOut_3C_data_stream_2_V_full_n, ap_CS_fsm_state5)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    imgOut_3C_data_stream_2_V_din <= tmp_9_reg_350;

    imgOut_3C_data_stream_2_V_write_assign_proc : process(imgOut_3C_data_stream_0_V_full_n, imgOut_3C_data_stream_1_V_full_n, imgOut_3C_data_stream_2_V_full_n, imgOut_1C_data_stream_V_full_n, ap_CS_fsm_state5)
    begin
        if ((not(((imgOut_1C_data_stream_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_2_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_1_V_full_n = ap_const_logic_0) or (imgOut_3C_data_stream_0_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    p_shl1_cast_fu_278_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_shl1_fu_271_p3),14));
    p_shl1_fu_271_p3 <= (tmp_7_reg_344 & ap_const_lv1_0);
    p_shl_cast_fu_267_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_shl_fu_260_p3),14));
    p_shl_fu_260_p3 <= (tmp_7_reg_344 & ap_const_lv5_0);
    ...
    tmp_6_fu_282_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_267_p1) - unsigned(p_shl1_cast_fu_278_p1));
end behav;
