...
begin
    ...
    axi_last_V_fu_228_p2 <= "1" when (t_V_2_reg_188 = ap_const_lv11_3FF) else "0";
    exitcond2_fu_204_p2 <= "1" when (t_V_reg_177 = ap_const_lv10_300) else "0";
    exitcond_fu_216_p2 <= "1" when (t_V_2_reg_188 = ap_const_lv11_400) else "0";
    ...
    outStream_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_reg_270, ap_enable_reg_pp0_iter2, exitcond_reg_270_pp0_iter1_reg)
    begin
