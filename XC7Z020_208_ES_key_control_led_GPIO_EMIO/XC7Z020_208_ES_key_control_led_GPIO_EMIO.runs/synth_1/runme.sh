...
HD_PWD='C:/Users/mi/Desktop/Programma/ZYNQ/XC7Z020_208_ES_key_control_led_GPIO_EMIO/XC7Z020_208_ES_key_control_led_GPIO_EMIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_design_wrapper.tcl
