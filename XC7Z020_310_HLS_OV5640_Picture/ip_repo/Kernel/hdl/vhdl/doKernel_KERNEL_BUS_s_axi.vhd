...
entity doKernel_KERNEL_BUS_s_axi is
generic (
...
end entity doKernel_KERNEL_BUS_s_axi;
...
architecture behave of doKernel_KERNEL_BUS_s_axi is
    ...
    component doKernel_KERNEL_BUS_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component doKernel_KERNEL_BUS_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_kernel
int_kernel : doKernel_KERNEL_BUS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
...
entity doKernel_KERNEL_BUS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity doKernel_KERNEL_BUS_s_axi_ram;

architecture behave of doKernel_KERNEL_BUS_s_axi_ram is
