...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.280000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=6,HLS_SYN_FF=523,HLS_SYN_LUT=445,HLS_VERSION=2018_3}" *)
...
reg   [63:0] indvar_flatten_reg_153;
reg   [31:0] width_read_reg_316;
...
wire   [63:0] indvar_flatten_next_fu_182_p2;
reg   [2:0] tmp_keep_V_reg_335;
reg   [2:0] tmp_strb_V_reg_340;
reg   [0:0] tmp_user_V_reg_345;
reg   [0:0] tmp_last_V_reg_350;
reg   [0:0] tmp_id_V_reg_355;
reg   [0:0] tmp_dest_V_reg_360;
reg   [7:0] tmp_1_reg_365;
wire   [23:0] outChannel_data_V_fu_291_p4;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] bound_fu_171_p0;
wire   [31:0] bound_fu_171_p1;
wire   [7:0] R_fu_216_p4;
wire   [7:0] G_fu_226_p4;
wire   [7:0] tmp_fu_244_p1;
wire   [12:0] p_shl_fu_248_p3;
wire   [8:0] p_shl1_fu_260_p3;
wire   [13:0] p_shl_cast_fu_256_p1;
wire   [13:0] p_shl1_cast_fu_268_p1;
wire  signed [13:0] tmp_s_fu_272_p2;
wire  signed [15:0] grp_fu_299_p3;
wire   [7:0] grp_fu_299_p0;
wire   [7:0] grp_fu_299_p1;
wire  signed [15:0] grp_fu_307_p3;
...
wire   [15:0] grp_fu_299_p10;
wire   [15:0] grp_fu_307_p10;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_177_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten_reg_153 <= indvar_flatten_next_fu_182_p2;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        indvar_flatten_reg_153 <= 64'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_177_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_1_reg_365 <= {{grp_fu_299_p3[15:8]}};
...
always @ (*) begin
    if ((exitcond_flatten_fu_177_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_fu_177_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_177_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_177_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)))) begin
...
assign G_fu_226_p4 = {{inStream_V_data_V_0_data_out[15:8]}};

assign R_fu_216_p4 = {{inStream_V_data_V_0_data_out[23:16]}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_flatten_fu_177_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_177_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_177_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter0 = ((exitcond_flatten_fu_177_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state4_io = ((exitcond_flatten_reg_326 == 1'd0) & (outStream_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state4_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5_io = ((exitcond_flatten_reg_326_pp0_iter1_reg == 1'd0) & (outStream_V_data_V_1_ack_in == 1'b0));
end
...
assign bound_fu_171_p00 = width_read_reg_316;

assign bound_fu_171_p1 = bound_fu_171_p10;

assign bound_fu_171_p10 = height_0_data_reg;

assign bound_fu_171_p2 = (bound_fu_171_p0 * bound_fu_171_p1);

assign exitcond_flatten_fu_177_p2 = ((indvar_flatten_reg_153 == bound_reg_321) ? 1'b1 : 1'b0);

assign grp_fu_299_p0 = 16'd76;

assign grp_fu_299_p1 = grp_fu_299_p10;

assign grp_fu_299_p10 = R_fu_216_p4;

assign grp_fu_307_p0 = 16'd150;

assign grp_fu_307_p1 = grp_fu_307_p10;

assign grp_fu_307_p10 = G_fu_226_p4;
...
assign indvar_flatten_next_fu_182_p2 = (indvar_flatten_reg_153 + 64'd1);

assign outChannel_data_V_fu_291_p4 = {{{tmp_1_reg_365}, {tmp_1_reg_365}}, {tmp_1_reg_365}};
...
assign p_shl1_cast_fu_268_p1 = p_shl1_fu_260_p3;

assign p_shl1_fu_260_p3 = {{tmp_fu_244_p1}, {1'd0}};

assign p_shl_cast_fu_256_p1 = p_shl_fu_248_p3;

assign p_shl_fu_248_p3 = {{tmp_fu_244_p1}, {5'd0}};

assign tmp_fu_244_p1 = inStream_V_data_V_0_data_out[7:0];

assign tmp_s_fu_272_p2 = (p_shl_cast_fu_256_p1 - p_shl1_cast_fu_268_p1);
