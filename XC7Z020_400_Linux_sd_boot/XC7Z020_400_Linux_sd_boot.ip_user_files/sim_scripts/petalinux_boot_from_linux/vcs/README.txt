...
#
# Generated by export_simulation on Sun Oct 03 16:49:11 +0300 2021
#
################################################################################
...
switch to the './petalinux_boot_from_linux.sh' script.

./petalinux_boot_from_linux.sh -reset_run
...
./petalinux_boot_from_linux.sh -noclean_files

For more information on the script, please type './petalinux_boot_from_linux.sh -help'.
