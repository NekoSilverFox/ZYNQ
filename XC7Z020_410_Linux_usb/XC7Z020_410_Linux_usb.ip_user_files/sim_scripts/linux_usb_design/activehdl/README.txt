...
#
# Generated by export_simulation on Mon Oct 04 16:20:28 +0300 2021
#
################################################################################
...
switch to the './linux_usb_design.sh' script.

./linux_usb_design.sh -reset_run
...
./linux_usb_design.sh -noclean_files

For more information on the script, please type './linux_usb_design.sh -help'.
