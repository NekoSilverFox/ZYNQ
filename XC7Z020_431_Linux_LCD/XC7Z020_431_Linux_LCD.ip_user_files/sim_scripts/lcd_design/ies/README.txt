...
#
# Generated by export_simulation on Sun Oct 10 15:04:32 +0300 2021
#
################################################################################
...
'-reset_run' switch to the './lcd_design.sh' script.

./lcd_design.sh -reset_run
...
./lcd_design.sh -noclean_files

For more information on the script, please type './lcd_design.sh -help'.
