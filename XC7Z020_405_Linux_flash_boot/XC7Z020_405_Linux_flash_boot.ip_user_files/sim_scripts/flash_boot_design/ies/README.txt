...
#
# Generated by export_simulation on Mon Oct 04 13:43:22 +0300 2021
#
################################################################################
...
switch to the './flash_boot_design.sh' script.

./flash_boot_design.sh -reset_run
...
./flash_boot_design.sh -noclean_files

For more information on the script, please type './flash_boot_design.sh -help'.
