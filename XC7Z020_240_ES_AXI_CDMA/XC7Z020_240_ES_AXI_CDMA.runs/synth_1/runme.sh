...
HD_PWD='C:/Users/mi/Desktop/Programma/ZYNQ/XC7Z020_240_ES_AXI_CDMA/XC7Z020_240_ES_AXI_CDMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_axi_cdma_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_axi_cdma_wrapper.tcl
