...
HD_PWD='C:/Users/mi/Desktop/Programma/ZYNQ/XC7Z020_240_ES_AXI_CDMA/XC7Z020_240_ES_AXI_CDMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_axi_cdma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_axi_cdma_wrapper.tcl -notrace
