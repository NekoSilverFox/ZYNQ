...
`define TV_IN_inStream_TDATA "../tv/cdatafile/c.doCorner.autotvin_inStream_V_data_V.dat"
`define INGRESS_STATUS_inStream_TDATA "../tv/stream_size/stream_ingress_status_inStream_V_data_V.dat"
`define TV_IN_inStream_TKEEP "../tv/cdatafile/c.doCorner.autotvin_inStream_V_keep_V.dat"
`define INGRESS_STATUS_inStream_TKEEP "../tv/stream_size/stream_ingress_status_inStream_V_keep_V.dat"
`define TV_IN_inStream_TSTRB "../tv/cdatafile/c.doCorner.autotvin_inStream_V_strb_V.dat"
`define INGRESS_STATUS_inStream_TSTRB "../tv/stream_size/stream_ingress_status_inStream_V_strb_V.dat"
`define TV_IN_inStream_TUSER "../tv/cdatafile/c.doCorner.autotvin_inStream_V_user_V.dat"
`define INGRESS_STATUS_inStream_TUSER "../tv/stream_size/stream_ingress_status_inStream_V_user_V.dat"
`define TV_IN_inStream_TLAST "../tv/cdatafile/c.doCorner.autotvin_inStream_V_last_V.dat"
`define INGRESS_STATUS_inStream_TLAST "../tv/stream_size/stream_ingress_status_inStream_V_last_V.dat"
`define TV_IN_inStream_TID "../tv/cdatafile/c.doCorner.autotvin_inStream_V_id_V.dat"
`define INGRESS_STATUS_inStream_TID "../tv/stream_size/stream_ingress_status_inStream_V_id_V.dat"
`define TV_IN_inStream_TDEST "../tv/cdatafile/c.doCorner.autotvin_inStream_V_dest_V.dat"
...
module AESL_axi_s_inStream (
    input clk,
    input reset,
    output [24 - 1:0] TRAN_inStream_TDATA,
    output [3 - 1:0] TRAN_inStream_TKEEP,
    output [3 - 1:0] TRAN_inStream_TSTRB,
    ...
    reg [24 - 1:0] inStream_TDATA_write_data;
    reg inStream_TDATA_read_en;
    wire [24 - 1:0] inStream_TDATA_read_data;
    
    fifo #(786432, 24) fifo_inStream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [3 - 1:0] inStream_TKEEP_write_data;
    reg inStream_TKEEP_read_en;
    wire [3 - 1:0] inStream_TKEEP_read_data;
    
    fifo #(786432, 3) fifo_inStream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [3 - 1:0] inStream_TSTRB_write_data;
    reg inStream_TSTRB_read_en;
    wire [3 - 1:0] inStream_TSTRB_read_data;
    
    fifo #(786432, 3) fifo_inStream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(786432, 1) fifo_inStream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(786432, 1) fifo_inStream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(786432, 1) fifo_inStream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(786432, 1) fifo_inStream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
