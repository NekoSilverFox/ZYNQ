...
int main()
{
    ...
    valuefd_pl_led1 = open("/sys/class/gpio/gpio958/value", O_RDWR);
    valuefd_pl_led2 = open("/sys/class/gpio/gpio959/value", O_RDWR);
    valuefd_pl_led3 = open("/sys/class/gpio/gpio1022/value", O_RDWR);
    valuefd_pl_led4 = open("/sys/class/gpio/gpio1023/value", O_RDWR);
