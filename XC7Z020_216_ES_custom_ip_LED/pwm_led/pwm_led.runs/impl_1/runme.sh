...
HD_PWD='D:/ZYNQ_Mizar/SDK_Demo/7_custom_ip/pwm_led/pwm_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_led_wrapper.tcl -notrace
