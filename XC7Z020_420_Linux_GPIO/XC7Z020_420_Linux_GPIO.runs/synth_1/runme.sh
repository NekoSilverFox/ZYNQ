...
HD_PWD='C:/Users/mi/Desktop/Programma/ZYNQ/XC7Z020_420_Linux_GPIO/XC7Z020_420_Linux_GPIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_design_wrapper.tcl
