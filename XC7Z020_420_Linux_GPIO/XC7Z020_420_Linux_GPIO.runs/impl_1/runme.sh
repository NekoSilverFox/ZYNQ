...
HD_PWD='C:/Users/mi/Desktop/Programma/ZYNQ/XC7Z020_420_Linux_GPIO/XC7Z020_420_Linux_GPIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_design_wrapper.tcl -notrace
