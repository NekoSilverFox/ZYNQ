...
architecture behav of doCorner is 
    ...
    "doCorner,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-2,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=17.108000,HLS_SYN_LAT=802113,HLS_SYN_TPT=802110,HLS_SYN_MEM=61,HLS_SYN_DSP=2,HLS_SYN_FF=8441,HLS_SYN_LUT=9836,HLS_VERSION=2018_3}";
